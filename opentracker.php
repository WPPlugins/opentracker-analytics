<?php
/**
 * Plugin Name: Opentracker Analytics
 * Plugin URI: http://www.opentracker.net?wordPressPlugin
...
function opentracker_settings_link($links) {
  $settings_link = '<a href=' . admin_url("admin.php?page=opentracker>Settings") . '</a>';
